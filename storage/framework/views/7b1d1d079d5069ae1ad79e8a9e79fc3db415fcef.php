...
<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
  ...
  <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('frontend_assets/img/Split_ride_logo.png')); ?>" />
...
<body>
  ...
  <main>
        ...
        <div class="row">
          ...
          <div class="col-1-of-2">
            <div class="composition">
              <img src="<?php echo e(asset('frontend_assets/img/pic1.jpeg')); ?>" alt="photo1" class="composition__photo composition__photo--p1" />
              <img src="<?php echo e(asset('frontend_assets/img/pic2.jpeg')); ?>" alt="photo 2" class="composition__photo composition__photo--p2" />
              <img src="<?php echo e(asset('frontend_assets/img/pic3.jpeg')); ?>" alt="photo 3"
    ...
    <section class="section-tours">
      ...
      <div class="row">
         <?php $__currentLoopData = $ourFrontRides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ride): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card__cta">
                        ...
                        <?php endif; ?>
                            ...
                            <a href="/groupChatWithNewUser/<?php echo e($ride['id']); ?>/<?php echo e($ride['userId']); ?>" class="btn btn--white">Group Chat!</a>
                                <form action="/bookRideWithUser/<?php echo e($ride['id']); ?>/<?php echo e(Auth::user()->id); ?>" method="POST" id="bookNowForm">
                                    <?php echo csrf_field(); ?>
    ...
    <section class="section-stories">
      <div class="bg-video">
        <video class="bg-video__content" autoplay muted loop>
          <source src="<?php echo e(asset('frontend_assets/img/video.mp4')); ?>" type="video/mp4" />
          <source src="<?php echo e(asset('frontend_assets/img/video.webm')); ?>" type="video/webm" />
      ...
      <div class="row">
        <div class="story">
          <figure class="story__shape">
            <img src="<?php echo e(asset('frontend_assets/img/nat-8.jpg')); ?>" alt="Person on a tour" class="story__image" />
        ...
        <div class="story">
          <figure class="story__shape">
            <img src="<?php echo e(asset('frontend_assets/img/nat-9.jpg')); ?>" alt="Person on a tour" class="story__image" />
  ...
  <footer class="footer">
    <div class="footer__logo-box">
      <img src="<?php echo e(asset('frontend_assets/img/Split_ride_logo.png')); ?>" alt="Full logo" class="footer__logo" />
    </div>
    <div class="row">
      <div class="col-1-of-2">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Laravel_Projects/BookingWebSite/resources/views/index.blade.php ENDPATH**/ ?>