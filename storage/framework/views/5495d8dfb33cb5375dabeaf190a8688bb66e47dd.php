      ...
      <div class="row">
        <div class="book book1">
          <div class="book__form">
            <form class="form" method="post" action="<?php echo e(route('reset.password.post')); ?>">
              <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Laravel_Projects/BookingWebSite/resources/views/admin/auth/forgetPasswordLink.blade.php ENDPATH**/ ?>