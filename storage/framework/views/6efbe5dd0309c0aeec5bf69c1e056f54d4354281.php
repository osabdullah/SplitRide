            ...
            <form class="form" method="post" action="login">
              ...
              <?php if(Session::has('user_added')): ?>
                <div class="custom__alert custom__alert--red" role="alert">
                    <?php echo e(Session::get('user_added')); ?>

                </div>
              <?php elseif(Session::has('user_verified')): ?>
                <div class="custom__alert" role="alert">
                    <?php echo e(Session::get('user_verified')); ?>
              ...
              <div class="form__group">
               ...
               <div class="form__group">
                <a href="<?php echo e(url('/redirect')); ?>" class="btn btn--white">Login with google &rarr;</a>
              </div>
               </div>
            </form>
          </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Laravel_Projects/BookingWebSite/resources/views/login.blade.php ENDPATH**/ ?>